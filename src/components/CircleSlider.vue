<template>
    <span>
        ...
        >
            <g>
                <circle :stroke="circleColor" fill="none" :stroke-width="cpMainCircleStrokeWidth" :cx="cpCenter"
                        :cy="cpCenter" :r="radius"></circle>
                <text v-if="showValue" x="50%" y="50%" :stroke="textColor" text-anchor="middle" :stroke-width="strokeWidth" :dy="dy">{{text}}: {{value}}</text>
                <text v-else x="50%" y="50%" :stroke="textColor" text-anchor="middle" :stroke-width="strokeWidth" :dy="dy">{{text}}</text>
